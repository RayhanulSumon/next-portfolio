...
const SwitchDark: React.FC = () => {
  ...
  return (
    <button
      ...
      className="bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2 sm:p-3 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300"
    >
      {resolvedTheme === 'dark' ? (
