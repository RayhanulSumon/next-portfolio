    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-slate-900 dark:to-blue-950 transition-colors duration-300">
      ...
      <section className="pt-14 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          {/* Softer SVG backgrounds for light mode, more subtle and gentle */}
          <svg className="absolute top-0 left-0 w-96 h-96 opacity-10 blur-3xl text-blue-100 dark:text-blue-900 animate-pulse" fill="currentColor" viewBox="0 0 400 400">
            <circle cx="200" cy="200" r="200" />
          </svg>
          <svg className="absolute bottom-0 right-0 w-[32rem] h-[32rem] opacity-7 blur-3xl text-cyan-50 dark:text-cyan-900 animate-pulse" fill="currentColor" viewBox="0 0 400 400">
            <circle cx="200" cy="200" r="200" />
          </svg>
        </div>
      ...
      <section className="py-20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-md rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
