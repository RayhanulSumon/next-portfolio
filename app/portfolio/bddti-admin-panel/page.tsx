		...
		<section className="min-h-screen w-full bg-white dark:bg-slate-900 transition-colors duration-300">
			<div className="w-full max-w-4xl mx-auto px-4 py-10 md:py-16">
				...
				<h1 className="text-4xl md:text-5xl font-extrabold mb-8 text-center text-gray-900 dark:text-white">
					<span className="text-blue-700 dark:text-cyan-400">BDDTI Admin Panel</span> – Management Dashboard
				</h1>
				<div className="flex justify-center">
					<p className="mb-14 mt-2 text-lg md:text-xl leading-relaxed md:leading-loose text-center w-full max-w-5xl text-gray-700 dark:text-gray-100">
						The <span className="font-semibold text-blue-700 dark:text-cyan-400">BDDTI Admin Panel</span> is a secure, feature-rich dashboard for the Bangladesh Driving Training Institute. It enables staff to manage courses, users, content, and schedules, with advanced analytics and reporting. The panel streamlines administrative workflows, supports role-based access, and provides real-time insights for efficient institute management.
					</p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
					<div>
						...
						<ul className="list-disc list-inside space-y-2 text-base md:text-lg text-gray-800 dark:text-gray-100">
							<li><span className="font-semibold">Course and user management</span></li>
							<li><span className="font-semibold">Content editing and publishing</span></li>
							<li><span className="font-semibold">Analytics and reporting</span> with data visualization</li>
							<li><span className="font-semibold">Role-based access control</span></li>
							<li><span className="font-semibold">Class schedule management</span></li>
							<li><span className="font-semibold">Notifications and messaging</span> for staff</li>
					...
					<div>
						...
						<ul className="list-disc list-inside space-y-2 text-base md:text-lg text-gray-800 dark:text-gray-100">
							<li><span className="font-semibold">Full-stack development</span>: Next.js, React, RESTful APIs</li>
							<li><span className="font-semibold">UI/UX design</span> and implementation</li>
							<li><span className="font-semibold">Role-based access and security</span></li>
							<li><span className="font-semibold">Data visualization and analytics</span></li>
				...
				<div className="mb-10">
					...
					<p className="text-base md:text-lg text-gray-700 dark:text-gray-100">
						<span className="font-semibold text-blue-700 dark:text-cyan-400">Next.js</span>, <span className="font-semibold text-blue-700 dark:text-cyan-400">React</span>, <span className="font-semibold text-blue-700 dark:text-cyan-400">RESTful APIs</span>
					</p>
				</div>
				<div className="flex justify-center">
					<a
